...
--
-- Host: 127.0.0.1
-- Generation Time: 02 Jul 2019 pada 15.27
...
(14, 'test produk', 'test-produk', '', '', 1, 1, 4, 1, 1, 1, 1, 'test-produk20190702120737', '.jpg', 'superadmin', '2019-07-02 12:07:37', '', NULL),
(15, 'a', 'a', 'a', '<p>a</p>', 1, 1, 4, 1, 1, 1, 1, 'a20190702121239', '.jpg', 'superadmin', '2019-07-02 12:12:39', '', NULL);
...
(1, 2, '2019-07-01 07:59:05', 10000, 'jne', 'CTCYES', 1, NULL),
(2, 3, '2019-07-01 08:12:39', 45000, 'jne', 'YES', 2, '12456'),
(3, 3, '2019-07-01 08:26:35', 15000, 'jne', 'YES', 1, NULL),
(4, 6, '2019-07-01 09:36:30', 26000, 'jne', 'OKE', 2, '123123123123'),
(5, 6, '2019-07-01 10:57:35', 54000, 'jne', 'YES', 2, '123123123123'),
(6, 2, '2019-07-01 15:24:50', 10000, 'jne', 'CTCYES', 1, NULL),
(7, 2, '2019-07-02 11:56:36', 10000, 'jne', 'CTCYES', 2, '123123123123');
...
INSERT INTO `transaksi_detail` (`id_transdet`, `trans_id`, `user`, `produk_id`, `harga`, `berat`, `total_qty`, `total_berat`, `subtotal`, `catatan`) VALUES
(2, 2, 3, 13, 300000, 300, 3, 900, 900000, 'aaa'),
(4, 3, 3, 11, 72000, 200, 2, 400, 144000, 'aa'),
(7, 4, 6, 12, 54000, 300, 4, 1200, 216000, 'segera dikirim ya gan'),
(8, 5, 6, 13, 300000, 300, 3, 900, 900000, 'segera di kirim ya gan'),
(10, 1, 2, 12, 54000, 300, 2, 600, 108000, 'segera'),
(11, 6, 2, 11, 72000, 200, 2, 400, 144000, 'aaa'),
(12, 7, 2, 13, 300000, 300, 2, 600, 600000, 'aa');
...
(1, 'Super Admin', 'superadmin', '$2y$08$D8i7zeJSUQulCZKsx/FKGul8ZwWcBxcCGL34/J6Ipzs228xyS9TSG', 'admin@gmail.com', '081228289766', 6, 151, 'asdasdasdsa', 1, 1, 'super-admin20190627142247', '.png', '::1', NULL, NULL, NULL, NULL, NULL, 1562042606, 2147483647, '2019-07-02 11:43:26', '0000-00-00', 0),
(2, 'Davrin', 'davrinsyn', '$2y$08$jw4MKvIqyzRfEfif2XxbleOzxOmABseq05UB/wSn96EetXDcyoZIm', 'davrinsyn@gmail.com', '081361557026', 34, 278, 'Jl.Jamin Ginting', 2, 1, 'davrin20190701104153', '.png', '::1', NULL, NULL, 'a3NZBOU5-LWM7GbvDXHY.O0eceb447acdad9e0b2', 1561617252, '1WonbvYw2P2leMBhaiazge', 1562042597, 1560470637, '2019-07-02 11:43:17', '1997-04-03', 22),
(3, 'usertest', 'usertest', '$2y$08$Ii6u22NsT3AVwSoNNRYOD.Hkos5rchsITPO04RRdHwRM5EOnpQFgG', 'user@gmail.com', '08121212', 34, 15, 'Jl. Jamin ginting No.409', 2, 1, NULL, NULL, '::1', NULL, NULL, NULL, NULL, NULL, 1561944036, 1561943514, '2019-07-01 09:28:36', '1997-03-04', 22),
(6, 'roni', 'roni', '$2y$08$5plmibllxBEqir42/cZ2gOfqmE53T1WGOAwbuwD8TxVaMuR45jbuy', 'roni@gmail.com', '454554', 3, 106, 'asdas', 2, 1, NULL, NULL, '::1', NULL, NULL, NULL, NULL, NULL, 1561953444, 1561948553, '2019-07-01 10:57:24', '1998-03-04', 21);
