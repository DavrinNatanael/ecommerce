              ...
              <div class="box-body">
								...
								<?php echo form_open($action);?>
									<div class="form-group"><label>No. Urut</label>
										<?php echo form_input($no_urut,$recommendation->no_urut);?>
									</div>
									<div class="form-group"><label>Nama Produk</label>
										<?php echo form_dropdown('',$get_combo_produk,$recommendation->produk_id,$produk_id);?>
									</div>
									<?php echo form_input($id_recommendation,$recommendation->id_recommendation);?>
