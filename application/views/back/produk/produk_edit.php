              ...
              <div class="box-body">
								...
								<?php echo form_open_multipart($action);?>
									...
									<div class="form-group"><label>Keywords</label>
										<?php echo form_input($keywords, $produk->keywords);?>
									</div>
                    ...
                    <div class="col-lg-4"><label>Harga Normal</label>
									...
									<div class="row">
										<div class="col-lg-4"><label>Kategori</label>
											<?php echo form_dropdown('',$ambil_kategori,$produk->kat_id,$kat_id);?><br>
										</div>
										<div class="col-lg-4"><label>SubKategori</label>
											<?php echo form_dropdown('',$ambil_subkat,$produk->subkat_id,$subkat_id);?><br>
										</div>
									</div>
