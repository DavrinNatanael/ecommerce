<div id='cssmenu' class="align-center">
  <ul>
    ...
    <?php if(isset($_SESSION['identity']) && $_SESSION['usertype'] == '2'){ ?>
      <li><a href="<?php echo base_url('cart') ?>"><i class="fa fa-shopping-cart"></i> Keranjang (0)</a></li>
    <?php } else { ?>
      <li><a href="<?php echo base_url('auth/register') ?>"><i class="fa fa-shopping-cart"></i> Keranjang (0)</a></li>
    <?php } ?>
    <?php if(isset($_SESSION['identity']) && $_SESSION['usertype'] == '2'){ ?>
    <li>
