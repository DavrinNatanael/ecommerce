    ...
    <table>
      <thead>
        <tr>
          ...
          <th style="text-align: center; background: #ddd; width: 190px">Daftar Produk</th>
          ...
          <th style="text-align: center; background: #ddd; width: 70px">Catatan</th>
        </tr>
      </thead>
      <tbody>
      <?php $no=1; foreach ($cart_finished as $cart){ ?>
        <tr>
          ...
          <td style="text-align:left;width: 190px"><?php echo $cart->judul_produk ?></td>
          ...
          <td style="text-align:center;width: 70px"><?php echo $cart->catatan ?></td>
        </tr>
      <?php } ?>
      </tbody>
    </table>
